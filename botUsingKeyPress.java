            ...
            while(true){
                ...
                if(first.equals(black)){
                    ...
                    while(!first.equals(clicked)){
                        ...
                        first = new Color(img.getRGB(tileOne.x - topLeft.x,tileOne.y - topLeft.y));
                        System.out.println(first);
                    }
                }else if(second.equals(black))
                {
                    ...
                    while(!second.equals(clicked)){
                        img = robot.createScreenCapture(rec);
                        second = new Color(img.getRGB(tileTwo.x - topLeft.x,tileTwo.y - topLeft.y));
                        System.out.println(second);
                    }
                }else if(third.equals(black))
                {
                    ...
                    while(!third.equals(clicked)){
                        img = robot.createScreenCapture(rec);
                        third = new Color(img.getRGB(tileThree.x - topLeft.x,tileThree.y - topLeft.y));
                        System.out.println(third);
                    }
                }else if(fourth.equals(black))
                {
                    ...
                    while(!fourth.equals(clicked)){
                        img = robot.createScreenCapture(rec);
                        fourth = new Color(img.getRGB(tileFour.x - topLeft.x,tileFour.y - topLeft.y));
                        System.out.println(fourth);
                    }
                }
